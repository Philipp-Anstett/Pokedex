                ...
                function (e, t, n) {
                  ...
                  (t.exports = u),
                    ...
                    (u.prototype.then = function (e, t) {
                      ...
                      return (
                        this.state !== c
                          ? l(n, this.state === s ? e : t, this.outcome)
                    ...
                    (u.all = function (e) {
                      ...
                      for (
                        var a = new Array(n), s = 0, c = -1, u = new this(o);
                        ++c < n;
              ...
              4: [
                function (e, t, n) {
                        ...
                        return a
                          ...
                          .then(function () {
                            if (
                              ...
                              return (
                                e.db && (e.version = e.db.version + 1), O(e)
                              );
                          })
                          .then(function () {
                            return (function (e) {
                  ...
                  var j = {
                    ...
                    _initStorage: function (e) {
                      ...
                      o ||
                        ...
                        o.forages.push(t),
                        t._initReady ||
                          ((t._initReady = t.ready), (t.ready = N));
                      var i = [];
                      function s() {
                        return a.resolve();
                      }
                      ...
                      return a
                        ...
                        .then(function (e) {
                          return (
                            (n.db = e),
                            R(n, t._defaultConfig.version) ? O(n) : e
                          );
                        })
                        .then(function (e) {
                      ...
                      if (
                        ...
                        e &&
                          ("[object ArrayBuffer]" === n ||
                            (e.buffer &&
                              "[object ArrayBuffer]" === $.call(e.buffer))))
                      ) {
                        var r,
                          o = P;
                  ...
                  var te = {
                      ...
                      key: function (e, t) {
                        var n = this,
                          r = n.ready().then(function () {
                            ...
                            return (
                              t && (t = t.substring(r.keyPrefix.length)), t
                            );
                          });
                        return s(r, t), r;
                      },
                    ...
                    se = [
                      ae.INDEXEDDB._driver,
                      ae.WEBSQL._driver,
                      ae.LOCALSTORAGE._driver,
                    ],
                    ce = ["dropInstance"],
                    ue = [
                      "clear",
                          ...
                          return (
                            (this._driverSet = u
                              ...
                              .catch(function () {
                                ...
                                return (
                                  (r._driverSet = a.reject(e)), r._driverSet
                                );
                              })),
      ...
      (() => {
                    ...
                    Q.forEach(n, function (n, i) {
                      !0 ===
                        (!(Q.isUndefined(n) || null === n) &&
                          o.call(t, n, Q.isString(i) ? i.trim() : i, r, l)) &&
                        e(n, r ? r.concat(i) : [i]);
                    }),
                    f.pop();
                }
        ...
        const he = class {
          ...
          ve =
            ge &&
            (!ye ||
              ["ReactNative", "NativeScript", "NS"].indexOf(ye.product) < 0),
          be =
        ...
        const $e = (e) => {
            ...
            if (
              ...
              (o && Q.isFunction(o) && (o = o(t)), o || (!1 !== o && Me(t.url)))
            ) {
            ...
            function (e) {
              return new Promise(function (t, n) {
                ...
                m.open(r.method.toUpperCase(), r.url, !0),
                  ...
                  (m.onabort = function () {
                    m &&
                      (n(new te("Request aborted", te.ECONNABORTED, e, m)),
                      (m = null));
                  }),
                  (m.onerror = function () {
                    n(new te("Network Error", te.ERR_NETWORK, e, m)),
                      (m = null);
                  }),
                  ...
                  h &&
                    (([c, f] = Le(h, !0)), m.addEventListener("progress", c)),
                  d &&
                    m.upload &&
                    (([s, u] = Le(d)),
              ...
              const o = function (e) {
                if (!n) {
                  ...
                  r.abort(
                    t instanceof te
                      ? t
                      : new Be(t instanceof Error ? t.message : t)
                  );
                }
              };
              let i =
          ...
          ct = (e) => {
            ...
            for (let i = 0; i < t; i++) {
              ...
              if (
                ...
                throw new te(`Unknown adapter '${t}'`);
              if (r) break;
              o[t || "#" + i] = r;
            }
            if (!r) {
        ...
        class mt {
          ...
          getUri(e) {
            return de(
              ze((e = He(this.defaults, e)).baseURL, e.url),
              e.params,
              e.paramsSerializer
            );
          }
          ...
          return new Promise((n, r) => {
            ...
            St.get(t, i)
              .then((i) => {
                i.status >= 400
                  ? r(i)
                  : (e.cache && o().setItem(`${_t}${t}`, i.data), n(i.data));
              })
              .catch((e) => {
                r(e);
              });
        ...
        class At {
          constructor(e = {}) {
            (this.protocol = "https"),
              ...
              e.hasOwnProperty("versionPath") &&
                (this.versionPath = e.versionPath),
              ...
              e.hasOwnProperty("cacheImages") &&
                (this.cacheImages = e.cacheImages);
          }
        }
        ...
        class Tt {
            ...
            (this.config = new At(e)),
                ...
                (this[t] = (t) => {
                  if (t) {
                    if ("number" == typeof t || "string" == typeof t)
                      return Ot(
                        this.config,
                        `${this.config.versionPath}${e[2].replace(":id", t)}`
                      );
                    if ("object" == typeof t)
                      return Promise.all(
                        (function (e, t, n) {
                          return n.map((n) =>
                            Ot(e, `${e.versionPath}${t[2].replace(":id", n)}`)
                          );
                        })(this.config, e, t)
                      );
                  }
              ...
              a.forEach((e) => {
                ...
                (this[t] = (t) => {
                  ...
                  return (
                    t &&
                      (t.hasOwnProperty("offset") && (r = t.offset),
                      t.hasOwnProperty("limit") && (n = t.limit)),
                    Ot(
                      this.config,
                      `${this.config.versionPath}${e[1]}?limit=${n}&offset=${r}`
                    )
                  );
                }),
                  (this[e[0]] = this[t]);
          ...
          resource(e) {
            return "string" == typeof e
              ? Ot(this.config, e)
              : Array.isArray(e)
              ? Promise.all(e.map((e) => Ot(this.config, e)))
              : "String or Array is required";
          }
        }
      })(),
      r
